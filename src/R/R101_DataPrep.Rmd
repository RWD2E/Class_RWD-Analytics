...
```{r}
df<-readRDS("C:/proj/data/als_aset.rda")
```
...
# more on: https://cran.r-proj.org/web/packages/lubridate/vignettes/lubridate.html
##=======================================================================================
...
bmi<-dbGetQuery(myconn,"select * from CLASS_MEMBER_BBME8550_DB.PUBLIC.ALS_ELIG_BMI")
head(bmi)
```
...
```{r}
saveRDS(df2,file="C:/proj/data/als_aset2.rda")
```