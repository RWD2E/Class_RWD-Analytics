...
aset<-readRDS("C:/proj/data/als_aset2.rda")
```
...
KS-test whether the two numerical variables are coming from the same distribution, which is a much stronger hypothesis compared with 
